...
const MyChart = NextDynamic(() => import('./components/MyChart'), { ssr: false });
const BrushChart = NextDynamic(() => import('./components/BrushChart'), { ssr: false });
const BrushChart2 = NextDynamic(() => import('./components/BrushChart2'), { ssr: false });
const BrushChart3 = NextDynamic(() => import('./components/BrushChart3'), { ssr: false });
        ...
        <div className="flex h-auto flex-wrap gap-2">
          ...
          <div className="h-auto flex-1 flex-wrap bg-white">
            <div className="w-full flex-auto h-auto flex-col text-white">
              ...
              <BrushChart3 chartID="cpu" graphLabel="CPU"></BrushChart3>
              <BrushChart3 chartID="gpu" graphLabel="GPU"></BrushChart3>
